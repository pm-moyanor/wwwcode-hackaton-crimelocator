...
const totalCountColors = [
  ...
  { range: [30, 60], color: "rgba(255, 72, 112, 0.8)", width: 45, height: 45 },
  { range: [60, 100], color: "rgba(255, 42, 139, 0.8)", width: 50, height: 50 },
  { range: [100, 200], color: "rgba(255, 0, 126, 0.8)", width: 55, height: 55 },
  { range: [200, Infinity], color: "rgba(255, 0, 71, 0.8)", width: 65, height: 65 },
];
